     ...
     wxDPOS, wxDSIZE, wxCFF)
{
    ...
    sg->Add(new wxComboBox(this, wxID_ANY, wxEmptyString, wxDPOS, wxDSIZE, 0, static_cast<const wxString *>(NULL), wxCB_SORT), wxGBPosition(5, 1), wxDefaultSpan, wxACV | wxALL, 3);
