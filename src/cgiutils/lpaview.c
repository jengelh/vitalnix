/*
 *	lpaview - Web interface for print accounting statistics
...
static void print_table(const char *user, struct HXbtree *data, MYSQL_RES *res)
{
	...
	printf("<p><b>Statistics for user \"%s\"</b></p>"
	...
	if (details)
		printf("<td align=\"center\" class=\"gray\" bgcolor=\"#80FFFF\">C</td>"
	...
	printf("<td align=\"center\" class=\"gray\">Ink coverage</td>"
