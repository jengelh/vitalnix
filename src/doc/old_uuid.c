 ...
 */
static char *tw0_encode(int day, int month, int year)
{
	char *ret;
...
static void tw0_decode(const char *code, int *day, int *month, int *year)
{
	char tmp[4];
	tmp[3] = '\0';
 ...
 */
static char *dt4_encode(const char *date)
{
...
static char *dt3_encode(const char *date)
{
	unsigned int year, month, day;
	struct tm tm = {};
	char *s;
 ...
 */
static char *v0_encode(const char *date)
{
	unsigned int year, month, day;
	int ret = 0;
	char *s;
