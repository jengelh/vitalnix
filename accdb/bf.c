...
/* Provided since your Linux distribution vendor's GLIBC might not have it yet.
Credit goes to Solar Designer <solar [at] openwall com>. */
 ...
 * cracking removed.
 *
 * Written by Solar Designer <solar [at] openwall com> in 1998-2002, and placed
 ...
 * by Niels Provos <provos [at] physnet uni-hamburg de>, and uses some of his
...
#include <errno.h>
#ifndef __set_errno
#    define __set_errno(__val) (errno = (__val))
#endif
...
#if defined(__i386__) || defined(__alpha__) || defined(__hppa__)
#    define BF_SCALE 1
#else
#    define BF_SCALE 0
#endif
